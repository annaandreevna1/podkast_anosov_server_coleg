    ...
    return (
      <div className="min-h-screen relative flex items-center justify-center px-4 py-8" style={{
        ...
        <div className="relative z-10 w-full max-w-2xl">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 text-center">
            <ThumbsUp className="w-12 h-12 sm:w-16 sm:h-16 text-green-400 mx-auto mb-4" />
            <h1 className="text-2xl sm:text-3xl text-white mb-4">Спасибо за ваш отзыв!</h1>
            <p className="text-purple-200 mb-6 text-sm sm:text-base">
              Вы уже оставили отзыв о работе системы. Мы ценим ваше мнение!
            </p>
            <Link
              to="/"
              className="inline-block bg-gradient-to-r from-amber-500 to-orange-600 text-white px-6 py-3 rounded-lg font-bold hover:shadow-lg hover:shadow-amber-500/50 transition-all text-sm sm:text-base"
            >
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8">
          <div className="text-center mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl text-white mb-2">Отзыв о работе системы</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
              ...
              <div className="flex items-start gap-2 sm:gap-3 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 text-purple-200 cursor-pointer text-sm sm:text-base">
                      <input
                        type="radio"
                        name="hasProblems"
                  ...
                  {formData.hasProblems && (
                    <div className="mt-4">
                      <label htmlFor="problems" className="block text-xs sm:text-sm text-purple-200 mb-2">
                        Опишите проблемы:
                      </label>
                      <textarea
                        id="problems"
                        ...
                        className="w-full bg-white/5 border border-white/20 rounded-lg py-3 px-4 text-white placeholder-purple-300/50 focus:outline-none focus:border-purple-400 transition-colors min-h-[100px] text-sm sm:text-base"
                        placeholder="Подробно опишите проблемы, с которыми вы столкнулись..."
                      />
                      {errors.problems && (
                        <p className="text-red-300 text-xs sm:text-sm mt-1">{errors.problems}</p>
                      )}
                    </div>
                  )}
                </div>
            ...
            <div className="bg-white/5 rounded-xl p-4 sm:p-6">
              <div className="flex items-start gap-2 sm:gap-3 mb-4">
                <Lightbulb className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-400 flex-shrink-0 mt-1" />
                <div className="flex-1">
                  <h2 className="text-lg sm:text-xl text-white mb-4">
                  ...
                  {errors.recommendations && (
                    <p className="text-red-300 text-xs sm:text-sm mt-1">{errors.recommendations}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-4 sm:p-6">
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1">
                  <h2 className="text-lg sm:text-xl text-white mb-4">Оцените систему</h2>
                  ...
                  {errors.rating && (
                    <p className="text-red-300 text-xs sm:text-sm mt-1">{errors.rating}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white py-3 sm:py-4 rounded-lg font-bold hover:shadow-lg hover:shadow-amber-500/50 transition-all text-base sm:text-lg"
            >
              Отправить отзыв
            </button>
          </form>
